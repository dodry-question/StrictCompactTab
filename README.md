...
* **Shortcut Categories & Tabs**: Organize your favorite sites into custom categories (e.g., Work, Dev, Entertainment). If only one category exists, the interface remains clean and classic. If two or more exist, an elegant horizontal category bar appears above the shortcut grid.
